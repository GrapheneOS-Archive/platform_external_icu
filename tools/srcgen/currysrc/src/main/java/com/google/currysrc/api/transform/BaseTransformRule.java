...
/**
 * A base implementation of {@link TransformRule}.
 */
abstract class BaseTransformRule implements TransformRule {
  protected final SourceMatcher matcher;
  protected final boolean mustModify;

  protected BaseTransformRule(SourceMatcher matcher, boolean mustModify) {
