...
public class SerializableTest extends TestFmwk.TestGroup
{
    ...
    static {
        ...
        map.put("android.icu.util.SimpleTimeZone", new SimpleTimeZoneHandler());
        map.put("android.icu.util.RuleBasedTimeZone", new RuleBasedTimeZoneHandler());
        map.put("android.icu.util.VTimeZone", new VTimeZoneHandler());
        map.put("android.icu.util.DateTimeRule", new DateTimeRuleHandler());
        map.put("android.icu.util.AnnualTimeZoneRule", new AnnualTimeZoneRuleHandler());
        map.put("android.icu.util.InitialTimeZoneRule", new InitialTimeZoneRuleHandler());
        map.put("android.icu.util.TimeArrayTimeZoneRule", new TimeArrayTimeZoneRuleHandler());
        map.put("android.icu.util.ULocale", new ULocaleHandler());
        map.put("android.icu.util.Currency", new CurrencyHandler());
        map.put("android.icu.impl.JavaTimeZone", new JavaTimeZoneHandler());
        map.put("android.icu.impl.OlsonTimeZone", new OlsonTimeZoneHandler());
        map.put("android.icu.impl.TimeZoneAdapter", new TimeZoneAdapterHandler());
        map.put("android.icu.math.BigDecimal", new BigDecimalHandler());
        map.put("android.icu.math.MathContext", new MathContextHandler());
        
        map.put("android.icu.text.NumberFormat", new FormatTests.NumberFormatHandler());
        map.put("android.icu.text.DecimalFormat", new FormatTests.DecimalFormatHandler());
        map.put("android.icu.text.CompactDecimalFormat", new FormatTests.CompactDecimalFormatHandler());
        map.put("android.icu.text.RuleBasedNumberFormat", new FormatTests.RuleBasedNumberFormatHandler());
        map.put("android.icu.text.CurrencyPluralInfo", new FormatTests.CurrencyPluralInfoHandler());
        map.put("android.icu.text.DecimalFormatSymbols", new FormatTests.DecimalFormatSymbolsHandler());
        map.put("android.icu.text.MessageFormat", new FormatTests.MessageFormatHandler());
        map.put("android.icu.text.DateFormat", new FormatTests.DateFormatHandler());
        map.put("android.icu.text.DateFormatSymbols", new FormatTests.DateFormatSymbolsHandler());
        map.put("android.icu.util.DateInterval", new DateIntervalHandler());
        map.put("android.icu.text.DateIntervalFormat", new FormatTests.DateIntervalFormatHandler());
        map.put("android.icu.text.DateIntervalInfo", new FormatTests.DateIntervalInfoHandler());
        map.put("android.icu.text.DateIntervalInfo$PatternInfo", new FormatTests.PatternInfoHandler());
        map.put("android.icu.text.SimpleDateFormat", new FormatTests.SimpleDateFormatHandler());
        map.put("android.icu.text.ChineseDateFormat", new FormatTests.ChineseDateFormatHandler());
        map.put("android.icu.text.ChineseDateFormatSymbols", new FormatTests.ChineseDateFormatSymbolsHandler());
        map.put("android.icu.impl.DateNumberFormat", new FormatTests.DateNumberFormatHandler());
        map.put("android.icu.text.PluralFormat", new FormatTests.PluralFormatHandler());
        map.put("android.icu.text.PluralRules", new FormatTests.PluralRulesHandler());
        map.put("android.icu.text.PluralRulesSerialProxy", new FormatTests.PluralRulesSerialProxyHandler());
        map.put("android.icu.text.TimeUnitFormat", new FormatTests.TimeUnitFormatHandler());
        map.put("android.icu.text.SelectFormat", new FormatTests.SelectFormatHandler());
        map.put("android.icu.impl.TimeZoneNamesImpl", new FormatTests.TimeZoneNamesHandler());
        map.put("android.icu.text.TimeZoneFormat", new FormatTests.TimeZoneFormatHandler());
        map.put("android.icu.impl.TimeZoneGenericNames", new FormatTests.TimeZoneGenericNamesHandler());
        map.put("android.icu.impl.TZDBTimeZoneNames", new FormatTests.TZDBTimeZoneNamesHandler());

        map.put("android.icu.util.Calendar", new CalendarTests.CalendarHandler());
        map.put("android.icu.util.BuddhistCalendar", new CalendarTests.BuddhistCalendarHandler());
        map.put("android.icu.util.ChineseCalendar", new CalendarTests.ChineseCalendarHandler());
        map.put("android.icu.util.CopticCalendar", new CalendarTests.CopticCalendarHandler());
        map.put("android.icu.util.DangiCalendar", new CalendarTests.DangiCalendarHandler());
        map.put("android.icu.util.EthiopicCalendar", new CalendarTests.EthiopicCalendarHandler());
        map.put("android.icu.util.GregorianCalendar", new CalendarTests.GregorianCalendarHandler());
        map.put("android.icu.util.HebrewCalendar", new CalendarTests.HebrewCalendarHandler());
        map.put("android.icu.util.IndianCalendar", new CalendarTests.IndianCalendarHandler());
        map.put("android.icu.util.IslamicCalendar", new CalendarTests.IslamicCalendarHandler());
        map.put("android.icu.util.JapaneseCalendar", new CalendarTests.JapaneseCalendarHandler());
        map.put("android.icu.util.PersianCalendar", new CalendarTests.PersianCalendarHandler());
        map.put("android.icu.util.TaiwanCalendar", new CalendarTests.TaiwanCalendarHandler());
        
        map.put("android.icu.text.ArabicShapingException", new ExceptionTests.ArabicShapingExceptionHandler());
        map.put("android.icu.text.StringPrepParseException", new ExceptionTests.StringPrepParseExceptionHandler());
        map.put("android.icu.util.UResourceTypeMismatchException", new ExceptionTests.UResourceTypeMismatchExceptionHandler());
        map.put("android.icu.impl.InvalidFormatException", new ExceptionTests.InvalidFormatExceptionHandler());

        map.put("android.icu.text.NumberFormat$Field", new FormatTests.NumberFormatFieldHandler());
        map.put("android.icu.text.DateFormat$Field", new FormatTests.DateFormatFieldHandler());
        map.put("android.icu.text.ChineseDateFormat$Field", new FormatTests.ChineseDateFormatFieldHandler());
        map.put("android.icu.text.MessageFormat$Field", new FormatTests.MessageFormatFieldHandler());

        map.put("android.icu.impl.duration.BasicDurationFormat", new FormatTests.BasicDurationFormatHandler());
        map.put("android.icu.impl.RelativeDateFormat", new FormatTests.RelativeDateFormatHandler());
        map.put("android.icu.util.IllformedLocaleException", new ExceptionTests.IllformedLocaleExceptionHandler());
        map.put("android.icu.impl.locale.LocaleSyntaxException", new ExceptionTests.LocaleSyntaxExceptionHandler());
        map.put("android.icu.impl.IllegalIcuArgumentException", new ExceptionTests.IllegalIcuArgumentExceptionHandler());
    ...
    public SerializableTest()
    {
        super(
            new String[] {
                "android.icu.dev.test.serializable.CoverageTest",
                "android.icu.dev.test.serializable.CompatibilityTest"},
