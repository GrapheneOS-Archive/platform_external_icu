...
public class CompatibilityTest extends TestFmwk
{
    ...
    private static final String[][] SKIP_CASES = {
            ...
            {"ICU_51.1", "android.icu.text.CurrencyPluralInfo"},

            {"ICU_50.1", "android.icu.text.PluralFormat"},
            {"ICU_51.1", "android.icu.text.PluralFormat"},

            {"ICU_50.1", "android.icu.text.PluralRules"},
            {"ICU_51.1", "android.icu.text.PluralRules"},

            // GeneralMeasureFormat was in technical preview, but is going away after ICU 52.1.
            {"ICU_52.1", "android.icu.text.GeneralMeasureFormat"},

            // RuleBasedNumberFormat
            {"ICU_3.6",     "android.icu.text.RuleBasedNumberFormat"},

            // ICU 4.8+ MessageFormat is not serialization-compatible with previous versions.
            {"ICU_3.6",     "android.icu.text.MessageFormat"},
    };
}
