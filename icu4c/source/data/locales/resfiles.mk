...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt agq.txt\
 ...
 ar_SY.txt ar_TD.txt ar_TN.txt ar_XB.txt ar_YE.txt\
 as.txt as_IN.txt asa.txt asa_TZ.txt ast.txt\
 ast_ES.txt az.txt az_Cyrl.txt az_Cyrl_AZ.txt az_Latn.txt\
 az_Latn_AZ.txt bas.txt bas_CM.txt be.txt be_BY.txt\
 bem.txt bem_ZM.txt bez.txt bez_TZ.txt bg.txt\
 bg_BG.txt bm.txt bm_ML.txt bn.txt bn_BD.txt\
 bn_IN.txt bo.txt bo_CN.txt bo_IN.txt br.txt\
 br_FR.txt brx.txt brx_IN.txt bs.txt bs_Cyrl.txt\
 bs_Cyrl_BA.txt bs_Latn.txt bs_Latn_BA.txt ca.txt ca_AD.txt\
 ca_ES.txt ca_FR.txt ca_IT.txt ce.txt ce_RU.txt\
 ...
 dje.txt dje_NE.txt dsb.txt dsb_DE.txt dua.txt\
 dua_CM.txt dyo.txt dyo_SN.txt dz.txt dz_BT.txt\
 ebu.txt ebu_KE.txt ee.txt ee_GH.txt ee_TG.txt\
 el.txt el_CY.txt el_GR.txt en.txt en_001.txt\
 en_150.txt en_AG.txt en_AI.txt en_AS.txt en_AT.txt\
 ...
 en_GU.txt en_GY.txt en_HK.txt en_IE.txt en_IL.txt\
 ...
 en_PK.txt en_PN.txt en_PR.txt en_PW.txt en_RW.txt\
 ...
 en_WS.txt en_XA.txt en_ZA.txt en_ZM.txt en_ZW.txt\
 ...
 fa_AF.txt fa_IR.txt ff.txt ff_CM.txt ff_GN.txt\
 ff_MR.txt ff_SN.txt fi.txt fi_FI.txt fil.txt\
 fil_PH.txt fo.txt fo_DK.txt fo_FO.txt fr.txt\
 ...
 fr_MU.txt fr_NC.txt fr_NE.txt fr_PF.txt fr_PM.txt\
 fr_RE.txt fr_RW.txt fr_SC.txt fr_SN.txt fr_SY.txt\
 fr_TD.txt fr_TG.txt fr_TN.txt fr_VU.txt fr_WF.txt\
 fr_YT.txt fur.txt fur_IT.txt fy.txt fy_NL.txt\
 ga.txt ga_IE.txt gd.txt gd_GB.txt gl.txt\
 gl_ES.txt gsw.txt gsw_CH.txt gsw_FR.txt gsw_LI.txt\
 gu.txt gu_IN.txt guz.txt guz_KE.txt gv.txt\
 gv_IM.txt ha.txt ha_GH.txt ha_NE.txt ha_NG.txt\
 haw.txt haw_US.txt he.txt he_IL.txt hi.txt\
 hi_IN.txt hr.txt hr_BA.txt hr_HR.txt hsb.txt\
 hsb_DE.txt hu.txt hu_HU.txt hy.txt hy_AM.txt\
 id.txt id_ID.txt ig.txt ig_NG.txt ii.txt\
 ii_CN.txt is.txt is_IS.txt it.txt it_CH.txt\
 it_IT.txt it_SM.txt ja.txt ja_JP.txt jgo.txt\
 ...
 nb_NO.txt nb_SJ.txt nd.txt nd_ZW.txt ne.txt\
 ne_IN.txt ne_NP.txt nl.txt nl_AW.txt nl_BE.txt\
 nl_BQ.txt nl_CW.txt nl_NL.txt nl_SR.txt nl_SX.txt\
 nmg.txt nmg_CM.txt nn.txt nn_NO.txt nnh.txt\
 nnh_CM.txt nus.txt nus_SS.txt nyn.txt nyn_UG.txt\
 om.txt om_ET.txt om_KE.txt or.txt or_IN.txt\
 os.txt os_GE.txt os_RU.txt pa.txt pa_Arab.txt\
 pa_Arab_PK.txt pa_Guru.txt pa_Guru_IN.txt pl.txt pl_PL.txt\
 ps.txt ps_AF.txt pt.txt pt_AO.txt pt_BR.txt\
 ...
 tr_TR.txt twq.txt twq_NE.txt tzm.txt tzm_MA.txt\
 ug.txt ug_CN.txt uk.txt uk_UA.txt ur.txt\
 ...
 yi_001.txt yo.txt yo_BJ.txt yo_NG.txt yue.txt\
 yue_HK.txt zgh.txt zgh_MA.txt zh.txt zh_Hans.txt\
