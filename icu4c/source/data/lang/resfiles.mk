...
LANG_SOURCE = af.txt agq.txt ak.txt am.txt\
 ar.txt ar_EG.txt ar_LY.txt ar_SA.txt ar_XB.txt\
 ...
 en_XA.txt en_ZA.txt en_ZM.txt en_ZW.txt eo.txt\
 ...
 sr_Latn_ME.txt sr_Latn_XK.txt sv.txt sv_FI.txt sw.txt\
 ...
 yue_Hant.txt zgh.txt zh.txt zh_Hans.txt zh_Hant.txt\
